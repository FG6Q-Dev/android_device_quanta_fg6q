...
/*
 * see here: https://github.com/CyanogenMod/android_device_samsung_manta/blob/cm-13.0/libdmitry/libdmitry.c
 */
...
{
    ALOGI("GPS interposition library loaded. Your GPS should work in M now.");
}
...
{
    ALOGI("GPS interposition library unloading. Goodbye...");
