...
ucnv_setToUCallBack_53 (UConverter * converter,
                        ...
                        UErrorCode * err)
{
  return ucnv_setToUCallBack (converter,
                              newAction,
                              newContext,
                              oldAction,
                              oldContext,
...
ucnv_setFromUCallBack_53 (UConverter * converter,
                          ...
                          UErrorCode * err)
{
  return ucnv_setFromUCallBack (converter,
                                newAction,
                                newContext,
                                oldAction,
                                oldContext,
...
UCNV_TO_U_CALLBACK_STOP_53 (const void *context,
                            ...
                            UErrorCode * err)
{
  return UCNV_TO_U_CALLBACK_STOP (context,
                                  toUArgs,
                                  codeUnits,
                                  length,
                                  reason,
...
UCNV_FROM_U_CALLBACK_STOP_53 (const void *context,
                           ...
                           UErrorCode * err)
{
  return UCNV_FROM_U_CALLBACK_STOP  (context,
                                  fromUArgs,
                                  codeUnits,
                                  length,
                                  codePoint,
...
{
  return ucnv_convertEx(targetCnv, sourceCnv,
                  target, targetLimit,
                  source, sourceLimit,
                  pivotStart, pivotSource,
